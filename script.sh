...
winpty docker run -d -p 5000:5000 --net kaf --name=flaskapp flask_image:1.0
winpty docker network connect db flaskapp
winpty docker network connect front flaskapp
